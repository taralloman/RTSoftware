...
import BottoneAccettaPrenotazione from './../components/BottoneAccettaPrenotazione';
import BottoneDeclinaPrenotazione from './../components/BottoneDeclinaPrenotazione';

class BottonePrenotazioniProprietarioIA extends React.Component 
{
    constructor(props) {
        super(props);
        this.state = {
                ...
                return (
                    <div>
                        ...
                        <Modal size='xl' centered isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
                            <ModalHeader toggle={this.toggle}>Lista delle prenotazioni in attesa dei tuoi clienti</ModalHeader>
                                ...
                                <Table striped bordered hover size="sm">
                                    <thead>
                                        <td>
                                            ...
                                            <tr><strong>Id prenotazione</strong>
                                                {this.state.prenotazioni.map(prenotazione => <td>{prenotazione.id_prenotazione}</td>)}
                                            </tr>
                                            ...
                                            <tr>
                                                <br></br>
                                                {this.state.prenotazioni.map(prenotazione => <td><BottoneAccettaPrenotazione idPrenotazione={prenotazione.id_prenotazione}/></td>)}
                                            </tr>
                                            <tr>
                                                <br></br>
                                                {this.state.prenotazioni.map(prenotazione => <td><BottoneDeclinaPrenotazione idPrenotazione={prenotazione.id_prenotazione} /></td>)}
                                            </tr>
                                        </td>
                                    </thead>
                                </Table>    
...
export default BottonePrenotazioniProprietarioIA;