...
class BottonePrenotazioniClienteIA extends React.Component 
{
    constructor(props) {
        super(props);
        this.state = {
        ...
        else
        {
            ...
            {    return (
                    <div>
                        ...
                        <ModalHeader toggle={this.toggle}>Lista delle prenotazioni effettuate in attesa di un riscontro da parte dei rispettivi proprietari</ModalHeader>
...
export default BottonePrenotazioniClienteIA;